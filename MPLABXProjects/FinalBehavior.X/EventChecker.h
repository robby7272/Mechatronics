...
static enum {
    DARK, LIGHT
} prevLightState; // static var which holds prev light state

static unsigned char prevBumperState;
...
uint8_t CheckFLBumperEvent(void);

uint8_t CheckAllBumpersEvent(void);
