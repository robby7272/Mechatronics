...
#ifndef ReverseSideTapeService_H  // <- This should be changed to your own guard on both
#define ReverseSideTapeService_H  //    of these lines
...
#endif /* ReverseSideTapeService_H */
