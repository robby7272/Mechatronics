...
#ifndef Service_H  // <- This should be changed to your own guard on both
#define Service_H  //    of these lines
 ...
 *        queue, which will be handled inside RunService function. Remember
