...
static SecondTowerState_t CurrentState = InitPSubState; // <- change name to match ENUM
...
/**
 * @Function InitSecondTower(uint8_t Priority)
...
uint8_t InitSecondTower(void)
{
    ES_Event returnEvent;

    CurrentState = InitPSubState;
    returnEvent = RunSecondTower(INIT_EVENT);
...
/**
 * @Function RunSecondTower(ES_Event ThisEvent)
...
ES_Event RunSecondTower(ES_Event ThisEvent)
{
    uint8_t makeTransition = FALSE; // use to flag transition
    SecondTowerState_t nextState; // <- change type to correct enum
...
//            }
    ...
    if (makeTransition == TRUE) { // making a state transition, send EXIT and ENTRY
        ...
        RunSecondTower(EXIT_EVENT); // <- rename to your own Run function
        CurrentState = nextState;
        RunSecondTower(ENTRY_EVENT); // <- rename to your own Run function
    }
