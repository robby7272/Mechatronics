...
#define EVENT_CHECK_LIST CheckBattery, CheckTrackWire, CheckTrackWire2, CheckBeacon
...
#define TIMER2_RESP_FUNC PostSideTapeService
#define TIMER3_RESP_FUNC PostTheBrain
#define TIMER4_RESP_FUNC PostTheBrain
#define TIMER5_RESP_FUNC PostReverseSideTapeService
#define TIMER6_RESP_FUNC PostTheBrain
#define TIMER7_RESP_FUNC PostTheBrain
#define TIMER8_RESP_FUNC PostTheBrain
#define TIMER9_RESP_FUNC PostTheBrain
#define TIMER10_RESP_FUNC PostTheBrain
#define TIMER11_RESP_FUNC PostTheBrain
#define TIMER12_RESP_FUNC PostTheBrain
#define TIMER13_RESP_FUNC PostTheBrain
...
#define TapeTimer 1
#define SideTapeTimer 2
#define ShootingTimer 3
#define DeadTimer 4
#define ReverseSideTapeTimer 5
#define BigCircleTime 6
#define HellaStuckTimer 7
#define DoALittleSpin 8
#define WiggleOnceMore 9
#define BruhHowDidYouNotReadThatFrontBumperEvent 10
#define WeSpinninOutHere 11
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "TheBrain.h" 
// the name of the Init function
#define SERV_1_INIT InitTheBrain
// the name of the run function
#define SERV_1_RUN RunTheBrain
...
#if NUM_SERVICES > 3
// the header file with the public fuction prototypes
#define SERV_3_HEADER "TapeService.h"
// the name of the Init function
...
#if NUM_SERVICES > 4
// the header file with the public fuction prototypes
#define SERV_4_HEADER "SideTapeService.h"
// the name of the Init function
#define SERV_4_INIT InitSideTapeService
// the name of the run function
#define SERV_4_RUN RunSideTapeService
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public fuction prototypes
#define SERV_5_HEADER "ReverseSideTapeService.h"
// the name of the Init function
#define SERV_5_INIT InitReverseSideTapeService
// the name of the run function
#define SERV_5_RUN RunReverseSideTapeService
...
#if NUM_SERVICES > 6
// the header file with the public fuction prototypes
#define SERV_6_HEADER "ReverseSideTapeService.h"
// the name of the Init function
#define SERV_6_INIT InitReverseSideTapeService
// the name of the run function
#define SERV_6_RUN RunReverseSideTapeService
// How big should this services Queue be?
...
#if NUM_DIST_LISTS > 0 
#define DIST_LIST0 PostFSM
#endif
#if NUM_DIST_LISTS > 1 
#define DIST_LIST1 PostFSM
#endif
#if NUM_DIST_LISTS > 2 
#define DIST_LIST2 PostFSM
#endif
#if NUM_DIST_LISTS > 3 
#define DIST_LIST3 PostFSM
#endif
#if NUM_DIST_LISTS > 4 
#define DIST_LIST4 PostFSM
#endif
#if NUM_DIST_LISTS > 5 
#define DIST_LIST5 PostFSM
#endif
#if NUM_DIST_LISTS > 6 
#define DIST_LIST6 PostFSM
#endif
#if NUM_DIST_LISTS > 7 
#define DIST_LIST7 PostFSM
#endif
